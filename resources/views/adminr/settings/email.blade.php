                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            You can use the <a href="https://mailtrap.io" style="text-decoration: underline" target="_blank">mailtrap.io <x-cicon name="external-link" style="width: 10px" /></a> service for testing emails
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   class="form-control @if($errors->has('mail_driver')) is-invalid @endif"
                                                   name="mail_driver" id="mail_driver" placeholder="Mail Driver"
                                                   value="{{ old('mail_driver') ?? getSetting('mail_driver') }}"
                                                   required>
