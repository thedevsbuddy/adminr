...
@section('content')
    <div class="container-fluid" id="app">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{ route('adminr.templates.update', $template->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="code">{{ __('Code') }} (<small
                                                        class="text-danger">Can not be changed</small>)</label>
                                                <input type="text"
                                                       class="form-control @if($errors->has('code')) is-invalid @endif"
                                                       name="code" id="code" placeholder="{{ __('Mail Code') }}"
                                                       value="{{ $template->code ?? old('code') }}" readonly disabled>
                                                @if($errors->has('code'))
