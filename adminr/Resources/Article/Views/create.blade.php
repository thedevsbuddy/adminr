...
<div class="container-fluid">
    ...
    <div class="card">
        <form method="POST" action="{{ route( 'adminr.articles.store') }}" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group has-feedback @if($errors->has('slug')) has-error @endif">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control @if($errors->has('slug')) is-invalid @endif" placeholder="Slug" value="{{ old('slug') }}" required />
                                    @if ($errors->has('slug'))
                                        <span class="text-danger">
