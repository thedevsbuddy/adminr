<div
    class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show @if(isActiveRoute('adminr.builder')) c-sidebar-minimized @endif"
    id="sidebar">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="{{ route('adminr.index') }}">
                <svg class="c-sidebar-nav-icon">
                    <use xlink:href="{{ adminrIcon('cil-speedometer') }}"></use>
                </svg>
                {{ __('Dashboard') }}
            </a>
        </li>
                ...
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link"
                       href="{{ route('adminr.roles-and-permissions.index') }}">
                        <svg class="c-sidebar-nav-icon">
                            <use xlink:href="{{ adminrIcon('cil-star') }}"></use>
                        </svg>
