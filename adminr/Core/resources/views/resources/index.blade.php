        ...
        <div>
            <a href="{{ route('adminr.builder') }}" class="btn btn-primary btn-sm d-none d-sm-inline-block">
                <svg class="c-icon mr-1">
                    <use xlink:href="{{ adminrIcon('cil-library-add') }}"></use>
                </svg>
                {{ __('Add new resource') }}
            </a>
        </div>
...
{{--                                        </svg>--}}
{{--                                    </a>--}}
                                    <a href="{{ route('adminr.resources.configure', encrypt($resource->id)) }}" class="btn btn-sm mr-2 btn-icon btn-primary" title="Configure Permissions">
                                        <svg class="h-3 w-3">
                                            <use xlink:href="{{ adminrIcon('cil-cog') }}"></use>
                                        </svg>
                                    </a>
...
{{--                                        </svg>--}}
{{--                                    </a>--}}
{{--                                    <form class="d-none" id="resource_{{ $resource->id }}" action="{{ route('adminr.resources.destroy', $resource->id) }}" method="POST">--}}
{{--                                        @csrf--}}
{{--                                        @method('DELETE')--}}
{{--                                    </form>--}}
                                </td>
